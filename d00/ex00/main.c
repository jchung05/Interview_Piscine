...
int main(void)
{
	...
	--------------------*/
	printf("Price for the art piece \'%s\' is %i\n", "Guernica", searchPrice(arts, "Guernica"));
	printf("Price for the art piece \'%s\' is %i\n", "THE MYSTERY OF THE SEVEN STARS (plate, folio 7 verso) from THE APOCALYPSE", searchPrice(arts, "THE MYSTERY OF THE SEVEN STARS (plate, folio 7 verso) from THE APOCALYPSE"));
	printf("Price for the art piece \'%s\' is %i\n", "me in the shower", searchPrice(arts, "me in the shower"));
	printf("Price for the art piece \'%s\' is %i\n", "Mona Lisa", searchPrice(arts, "Mona Lisa"));
	printf("Price for the art piece \'%s\' is %i\n", "I don't exist!", searchPrice(arts, "I don't exist!"));
	return (0);
}
