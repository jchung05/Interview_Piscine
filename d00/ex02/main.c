...
int main(void)
{
	...
	printf("Price for the art piece \'%s\' is %i\n", "THE MYSTERY OF THE SEVEN STARS (plate, folio 7 verso) from THE APOCALYPSE", searchPrice(arts, n, "THE MYSTERY OF THE SEVEN STARS (plate, folio 7 verso) from THE APOCALYPSE"));
	printf("Price for the art piece \'%s\' is %i\n", "me in the shower", searchPrice(arts, n, "me in the shower"));
